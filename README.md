...
| 權限節點 | 預設 | 描述 |
|----------|------|------|
| `signwarp.private.use` | OP | 使用他人私人傳送錨點 |
| `signwarp.private.set` | 所有人 | 設定傳送錨點可見性 |
| `signwarp.invite` | 所有人 | 邀請/移除邀請功能 |
| `signwarp.invite.list` | 所有人 | 查看邀請列表 |
| `signwarp.invite.admin` | OP | 管理任何傳送錨點邀請 |
...
| `signwarp.group.manage` | 群組擁有者/OP | 管理群組（加入/移除傳送錨點和成員） |
